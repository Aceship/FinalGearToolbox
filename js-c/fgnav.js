...
$(document).ready(function(){
    ...
    //     content:[
    //         {
    //             href:"bannerlist.html",
    //             name:"Pilot Recruit & Mech Parts Banner",
    //         },{
    //             href:"aklevel.html",
    //             name:"Leveling"
    //         },{
    ...
    dropdown.forEach(drop => {
        ...
        if(typeof drop.content == "string"){
            ...
            navDropdown.push(`
            <li class="nav-item fg-thinborder ${isGroup?"active fg-navbar-active fg-darkfill":""}">
    ...
    let html = `
        ...
        <a class="navbar-brand" href="index.html" translate-id="topbar-1">
        Final Gear Toolbox</a>
