...
const jsonList = {
    ...
    machineArmorData    :"json/gamedata/sc/MachineArmorData.json",
    equipLegData        :"json/gamedata/sc/EquipLegData.json",
    itemData            :"json/gamedata/sc/ItemData.json",
    skillArrayData      :"json/gamedata/sc/SkillArrayData.json",
    trunkSkillData      :"json/gamedata/sc/TrunkSkillData.json",
    skillEffectData     :"json/gamedata/sc/SkillEffectData.json",
